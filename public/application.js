...
/***/ function(module, exports, __webpack_require__) {
	...
	var eventsGame = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	//  decidePlayer
	var decidePlayer = function decidePlayer(number) {
	...
	var findWinner = function findWinner() {
	  if (finalResult[0] === "x" && finalResult[1] === "x" && finalResult[2] === "x" || finalResult[3] === "x" && finalResult[4] === "x" && finalResult[5] === "x" || finalResult[6] === "x" && finalResult[7] === "x" && finalResult[8] === "x" || finalResult[0] === "x" && finalResult[3] === "x" && finalResult[6] === "x" || finalResult[1] === "x" && finalResult[4] === "x" && finalResult[7] === "x" || finalResult[2] === "x" && finalResult[5] === "x" && finalResult[8] === "x" || finalResult[0] === "x" && finalResult[4] === "x" && finalResult[8] === "x" || finalResult[2] === "x" && finalResult[4] === "x" && finalResult[6] === "x") {
	    finalResult = resettingArray;
	    resettingGame = true;
	    $('#show-winner').text("X wins");
	  } else if (finalResult[0] === "o" && finalResult[1] === "o" && finalResult[2] === "o" || finalResult[3] === "o" && finalResult[4] === "o" && finalResult[5] === "o" || finalResult[6] === "o" && finalResult[7] === "o" && finalResult[8] === "o" || finalResult[0] === "o" && finalResult[3] === "o" && finalResult[6] === "o" || finalResult[1] === "o" && finalResult[4] === "o" && finalResult[7] === "o" || finalResult[2] === "o" && finalResult[5] === "o" && finalResult[8] === "o" || finalResult[0] === "o" && finalResult[4] === "o" && finalResult[8] === "o" || finalResult[2] === "o" && finalResult[4] === "o" && finalResult[6] === "o") {
	    finalResult = resettingArray;
	    resettingGame = true;
	...
	var sendMove = function sendMove(number) {
	  if (currentPlayer === "x") {
	...
	var gamePlay = function gamePlay(number) {
	...
	// /reset button logic
	var resetTheBoard = function resetTheBoard() {
	  $(".square").text("");
	  currentPlayer = "x";
	  finalResult = ['', '', '', '', '', '', '', '', ''];
	  resettingGame = false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetFinished = function onGetFinished(event) {
	  event.preventDefault();
	...
	var onCreateNewGame = function onCreateNewGame(event) {
	  ...
	  api.createNewGAme().then(function (response) {
	    save.game = response.game;
	    $("#game-board").show();
	    $("#show-game").show();
	    $("#show-winner").show();
	    $("#show-FinishedGame").show();
	  }).then(game.resetTheBoard()).then(ui.success).catch(ui.failure);
	};
	...
	var onGetGame = function onGetGame(event) {
	  ...
	  if (form.game.id.length === 0) {
	    ...
	    api.showUserGame(form.game.id).then(function (response) {
	      save.game = response.game;
	...
	var onUpDateGame = function onUpDateGame(event) {
	  event.preventDefault();
	  var passmove = game.singleUpdate;
	  api.updateUserGame(passmove).then(ui.onSuccess).catch(ui.onError);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showUserGame = function showUserGame(id) {
	  return $.ajax({
	...
	var updateUserGame = function updateUserGame(data) {
	  return $.ajax({
